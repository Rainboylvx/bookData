...
游戏规则如下:
 ...
 - `跟班`也可以选一个`跟班`
 - 自己和`跟班`组成的队伍的长度,称为**强大值**
 - 越往右的小朋友身体越**强状**
 - 现在问每个朋友的**强大值**是多少?

想一想:如果你是最后一个小朋友F,你很聪明(狡猾),你是最强壮的,但是也很懒惰,不想通过观察每个小朋友的积分来计算自己的**强大值**,你应该怎么办?仔细思考一段时间!

**小朋友F可以这们做:**

 - 观察左边所的小朋友积分,记住那些积分比自己小的人
 - 你利用自己强壮身体**威胁**积分比自己小的人
 - 你说:**把你们各自的强大值告诉我,不然就尝尝我沙包大的拳头!**
 - F不管他们的强大值是怎么计算出来的
 - 如果F知道了这些信息,他选出一个最大值后加1,就是自己的**强大值**
