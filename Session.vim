...
nnoremap <silent> \ck :GscopeKill
xnoremap <silent> \ck :GscopeKill
onoremap <silent> \ck :GscopeKill
xnoremap <silent> \ca :GscopeFind a 
onoremap <silent> \ca :GscopeFind a 
nnoremap <silent> \cd :GscopeFind d 
xnoremap <silent> \cd :GscopeFind d 
onoremap <silent> \cd :GscopeFind d 
onoremap <silent> \ci :GscopeFind i =expand("<cfile>")
nnoremap <silent> \cf :GscopeFind f =expand("<cfile>")
xnoremap <silent> \cf :GscopeFind f =expand("<cfile>")
onoremap <silent> \cf :GscopeFind f =expand("<cfile>")
nnoremap <silent> \ce :GscopeFind e 
xnoremap <silent> \ce :GscopeFind e 
onoremap <silent> \ce :GscopeFind e 
nnoremap <silent> \ct :GscopeFind t 
xnoremap <silent> \ct :GscopeFind t 
onoremap <silent> \ct :GscopeFind t 
onoremap <silent> \cc :GscopeFind c 
nnoremap <silent> \cg :GscopeFind g 
xnoremap <silent> \cg :GscopeFind g 
onoremap <silent> \cg :GscopeFind g 
onoremap <silent> \cs :GscopeFind s 
nmap \r <Plug>(quickrun)
xmap \r <Plug>(quickrun)
omap \r <Plug>(quickrun)
nmap \html :se ft=html
nmap \css :se ft=css
nmap \js :se ft=javascript
nmap \php :se ft=php
nmap \ev :e $MYVIMRC
xmap \th :set nonumber:set norelativenumber:TOhtml:w %:r.html:q:set number:set relativenumber
nmap \th :set nonumber:set norelativenumber:TOhtml:w %:r.html:q:set number:set relativenumber
nmap \ra \rt\rbgg=Ggg
xmap \rt :call RemoveTabs()
nmap \rt :call RemoveTabs()
xmap \rm :%s///g
nmap \rm :%s///g
xmap \rb :let _s=@/|:%s/\s\+$//e|:let @/=_s|:nohl
nmap \rb :let _s=@/|:%s/\s\+$//e|:let @/=_s|:nohl
nmap \gs :Gsdiff
nmap \gd :Gdiff
nmap \gi :GitGutterToggle:GitGutterSignsToggle:GitGutterLineHighlightsToggle
nmap \mp :!rm ~/backup/.promptline:PromptlineSnapshot ~/backup/.promptline airline
nmap \fe :FencView
nmap \fla :LeaderfFunctionAll
nmap \fll :LeaderfFunction
nmap \bn :Tab /
nmap \bb :Tab /=
xmap \v "+p
nmap \v "+p
...
onoremap <silent> <Plug>(wildfire-quick-select) :call wildfire#QuickSelect(['i''', 'i"', 'i)', 'i]', 'i}', 'i>', 'ip'])
nnoremap <silent> <Plug>(wildfire-quick-select) :call wildfire#QuickSelect(['i''', 'i"', 'i)', 'i]', 'i}', 'i>', 'ip'])
vnoremap <silent> <Plug>(wildfire-fuel) :call wildfire#Fuel(v:count1)
onoremap <silent> <Plug>(wildfire-fuel) :call wildfire#Start(v:count1, ['i''', 'i"', 'i)', 'i]', 'i}', 'i>', 'ip'])
nnoremap <silent> <Plug>(wildfire-fuel) :call wildfire#Start(v:count1, ['i''', 'i"', 'i)', 'i]', 'i}', 'i>', 'ip'])
...
map <C-F10> :call Gdb()
map <C-F8> :call Compile()
map <F8> :call Run()
nmap <C-Down> :vertical resize
map <C-Up> =
nmap <C-Right> R
nmap <C-Left> 
nmap <F3> :w:shell
...
nnoremap í :LeaderfTag
xnoremap í :LeaderfTag
onoremap í :LeaderfTag
inoremap [ []i
imap \ihn :IHN
imap \is :IHS:A
imap \ih :IHS
inoremap <silent> \	 =UltiSnips#ExpandSnippet()
imap \html :se ft=htmlli
imap \css :se ft=cssli
imap \js :se ft=javascriptli
imap \php :se ft=phpli
imap \th :set nonumber:set norelativenumber:TOhtml:w %:r.html:q:set number:set relativenumber
imap \rt :call RemoveTabs()
imap \rm :%s///g
imap \rb :let _s=@/|:%s/\s\+$//e|:let @/=_s|:nohl
imap \v "+p
inoremap \; 
inoremap ] =ClosePair(']')
inoremap ` ``i
...
set fileignorecase
set gdefault
set guicursor=n-v-c:block-Cursor/lCursor,ve:ver35-Cursor,o:hor50-Cursor,i-ci:ver25-Cursor/lCursor,r-cr:hor20-Cursor/lCursor,sm:block-Cursor-blinkwait175-blinkoff150-blinkon175,n-v-c:blinkon0,i-ci:ver25-blinkon0
set guiheadroom=0
set helplang=cn
set hidden
set history=100
...
set regexpengine=1
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vimcdoc/,~/.vim/plugged/vim-quickrun/,~/.vim/plugged/vim-gutentags/,~/.vim/plugged/gutentags_plus/,~/.vim/plugged/gruvbox/,~/.vim/plugged/vim-airline/,~/.vim/plugged/vim-airline-themes/,~/.vim/plugged/ultisnips/,~/.vim/plugged/markdown-preview.vim/,~/.vim/plugged/syntastic/,~/.vim/plugged/YouCompleteMe/,~/.vim/plugged/emmet-vim/,~/.vim/plugged/vim-cpp-enhanced-highlight/,~/.vim/plugged/wmgraphviz.vim/,~/.vim/plugged/ListToggle/,~/.vim/plugged/a.vim/,~/.vim/plugged/vim-indent-guides/,~/.vim/plugged/vim-signature/,~/.vim/plugged/LeaderF/,~/.vim/plugged/rename.vim/,~/.vim/plugged/vim-easymotion/,~/.vim/plugged/nerdcommenter/,~/.vim/plugged/nerdtree/,~/.vim/plugged/nerdtree-git-plugin/,~/.vim/plugged/vim-table-mode/,~/.vim/plugged/vim-markdown/,~/.vim/plugged/vimproc.vim/,~/.vim/plugged/vimshell.vim/,~/.vim/plugged/wildfire.vim/,~/.vim/plugged/fcitx.vim/,~/.vim/plugged/rainbow/,~/.vim/plugged/DrawIt/,~/.vim/plugged/vim-vue/,~/.vim/plugged/vim-devicons/,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,~/.vim/after,~/.vim/plugged/ultisnips/after,~/.vim/plugged/vim-cpp-enhanced-highlight/after,~/.vim/plugged/vim-signature/after,~/.vim/plugged/vim-markdown/after,~/RainboyVim
set shiftround
set shiftwidth=4
set shortmess=ac
set showcmd
...
set splitbelow
set splitright
set statusline=%{gutentags#statusline()}%#warningmsg#%{SyntasticStatuslineFlag()}%*
set suffixes=.bak,~,.o,.info,.swp,.aux,.bbl,.blg,.brf,.cb,.dvi,.idx,.ilg,.ind,.inx,.jpg,.log,.out,.png,.toc
set noswapfile
set switchbuf=useopen,usetab
set tabline=%!airline#extensions#tabline#get()
set tabstop=4
set tags=./tags,./TAGS,tags,TAGS,/usr/include/c++/8.2.1/tags,/usr/include/graphviz/tags
set ttimeoutlen=0
...
set shortmess=aoO
badd +201 算法篇/图/二分图匹配/二分图匹配.md
badd +1 算法篇/分治/二分答案.md
badd +163 算法篇/分治/二分答案/index.md
badd +57 算法篇/网络流/最小路径覆盖/index.md
badd +0 算法篇/网络流/最小点覆盖与最大点权独立集/index.md
argglobal
silent! argdel *
edit 算法篇/网络流/最小点覆盖与最大点权独立集/index.md
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 26 + 66) / 133)
exe 'vert 2resize ' . ((&columns * 106 + 66) / 133)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
setlocal tabstop=4
setlocal tagcase=
setlocal tags=~/.cache/tags/home-rainboy-mycode-bookData-.tags,./tags,./TAGS,tags,TAGS,/usr/include/c++/8.2.1/tags,/usr/include/graphviz/tags
setlocal termwinkey=
